...
const vi = {
  ...
  hubBalanceLine: (balance: string) => `💰 Số dư: ${balance}`,
  hubOrdersLine: (n: number) => `🧾 Tổng đơn hàng: ${n}`,
  hubRateLine: (rate: string) => `⚖️ 1 USDT = ${rate}`,
...
const en: BotDictionary = {
  ...
  hubBalanceLine: (balance: string) => `💰 Balance: ${balance}`,
  hubOrdersLine: (n: number) => `🧾 Total orders: ${n}`,
  hubRateLine: (rate: string) => `⚖️ 1 USDT = ${rate}`,
...
const zh: BotDictionary = {
  ...
  shopHello: '今天想买点什么呢 ^^',
  hubBalanceLine: (balance: string) => `💰 余额：${balance}`,
  hubOrdersLine: (n: number) => `🧾 订单总数：${n}`,
  hubRateLine: (rate: string) => `⚖️ 1 USDT = ${rate}`,
