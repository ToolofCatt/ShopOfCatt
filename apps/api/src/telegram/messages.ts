...
const vi = {
  ...
  hubBackBtn: 'Quay Lại',
  shopTitle: '⭐ Chọn sản phẩm bên dưới ⭐',
  ...
  searchResults: (q: string, n: number) => `ℹ️ Kết quả cho: ${q}\nTìm thấy ${n} sản phẩm.`,
...
const en: BotDictionary = {
  ...
  hubLangBtn: '🌐 Ngôn ngữ / Language',
  hubBackBtn: 'Back',
  shopTitle: '⭐ Pick a product below ⭐',
  ...
  searchResults: (q: string, n: number) => `ℹ️ Results for: ${q}\nFound ${n} products.`,
...
const zh: BotDictionary = {
  ...
  searchResults: (q: string, n: number) => `ℹ️ 搜索结果：${q}\n找到 ${n} 件商品。`,
  accStatsTitle: '📊 个人统计',
  accSectionUser: '👥 账户',
