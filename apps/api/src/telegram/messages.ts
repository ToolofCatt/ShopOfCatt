...
const vi = {
  ...
  paymentInitializing: 'Phiên thanh toán chưa khởi tạo xong. Vui lòng thử lại sau hoặc chọn cách thanh toán khác.',
  ...
  deliveryCopyAll: "📋 Sao chép tất cả",
  deliveryCopyItem: "📋 Sao chép món",
  deliveryDownload: "📥 Tải .txt",
  deliveryWeb: "🌐 Xem trên web",
  deliveryLinkHint: "Link xem đơn có hiệu lực 15 phút. Không chia sẻ link; hết hạn hãy bấm Xem trên web để lấy link mới.",
  deliveredKeepSafe: 'Hãy lưu lại ngay — đừng chia sẻ với ai.',
  deliveredAsDocument: 'Nội dung dài được giao đầy đủ trong file đính kèm, không bị cắt bớt.',
...
const en: BotDictionary = {
  ...
  paymentInitializing: 'Payment initialization is not complete. Please try again later or choose another payment method.',
  ...
  deliveryCopyAll: "📋 Copy all",
  deliveryCopyItem: "📋 Copy item",
  deliveryDownload: "📥 Download .txt",
  deliveryWeb: "🌐 View on web",
  deliveryLinkHint: "This read-only link expires in 15 minutes. Do not share it; tap View on web again for a new link.",
  deliveredKeepSafe: 'Save them now — do not share with anyone.',
  deliveredAsDocument: 'The complete content is delivered in the attached file, without truncation.',
...
const zh: BotDictionary = {
  ...
  paymentInitializing: '支付会话尚未完成初始化。请稍后重试或选择其他支付方式。',
  ...
  deliveryCopyAll: "📋 复制全部",
  deliveryCopyItem: "📋 复制商品",
  deliveryDownload: "📥 下载 .txt",
  deliveryWeb: "🌐 网页查看",
  deliveryLinkHint: "此只读链接15分钟后失效。请勿分享；过期后重新点击网页查看获取新链接。",
  deliveredKeepSafe: '请立即保存——不要分享给任何人。',
  deliveredAsDocument: '完整内容将通过附件发送，不会截断。',
