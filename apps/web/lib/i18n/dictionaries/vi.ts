...
export const vi = {
  ...
  admin: {
    ...
    productTabsAria: 'Các phần chỉnh sửa sản phẩm',
    productTabOverview: 'Tổng quan',
    productTabContent: 'Nội dung & ảnh',
    productTabVariants: 'Loại & giá',
    productTabStock: 'Kho hàng',
    productTabTranslations: 'Bản dịch',
    productTabPreview: 'Xem trước',
    productOverviewTitle: 'Thông tin bán hàng',
    productOverviewHint: 'Tên, đường dẫn, cách sắp xếp và trạng thái của sản phẩm.',
    productContentTitle: 'Nội dung khách sẽ thấy',
    productContentHint: 'Quản lý ảnh bìa, thư viện ảnh và phần giới thiệu sản phẩm.',
    productDraftUnsaved: 'Chưa lưu',
    productDraftSaving: 'Đang lưu…',
    productDraftSaved: 'Đã lưu',
    productDraftError: 'Lưu thất bại',
    productDraftInvalid: 'Có trường chưa hợp lệ. Vui lòng kiểm tra lại.',
    ...
    rateManagedHint: 'Đang tự cập nhật — sửa tay sẽ bị ghi lại ở lần lấy sau.',
    rateCnyLabel: 'CNY cho 1 USDT',
    rateCnyHint: 'Chỉ để hiện giá cho khách chọn tiếng Trung. 0 = không quy đổi.',
    rateMarkupLabel: 'Biên cộng thêm (%)',
    rateMarkupHint: 'Cộng lên tỉ giá thị trường, cho cả VND và CNY.',
    rateRefreshNow: 'Lấy tỉ giá ngay',
    rateRefreshDone: 'Đã cập nhật tỉ giá.',
    rateRefreshFailed: 'Không lấy được tỉ giá — giữ tỉ giá cũ.',
    rateUpdatedAt: (luc: string) => `Cập nhật lần cuối: ${luc}`,
    ...
    telegramMembershipTitle: "Bắt buộc tham gia kênh",
    telegramMembershipHint: "Khách phải tham gia kênh trước khi dùng bot. Bot cần quyền quản trị viên để kiểm tra thành viên. Việc giao đơn đã thanh toán vẫn tiếp tục.",
    telegramMembershipChatLabel: "ID hoặc @username của kênh",
    telegramMembershipChatHint: "Chấp nhận ID rút gọn hoặc ID Bot API dạng -100…; máy chủ tự chuẩn hóa.",
    telegramMembershipLinkLabel: "Liên kết tham gia",
    telegramMembershipLinkHint: "Dùng https://t.me/ten_kenh hoặc link mời riêng. Kênh public có thể để trống rồi bấm Kiểm tra kênh.",
    telegramMembershipCheck: "Kiểm tra kênh",
    telegramMembershipChecking: "Đang kiểm tra…",
    telegramMembershipVerified: "Đã xác minh bot có quyền kiểm tra thành viên:",
    telegramOwnerAlertsTitle: 'Thông báo cho chủ shop',
    telegramOwnerAlertsPreview: 'Xem mẫu chủ shop',
    telegramOutOfStockPreview: 'Mẫu hết hàng',
    telegramOwnerAlertsHint:
      'Chat được cấu hình nhận tin mua thành công ẩn danh. Cảnh báo vận hành chỉ gửi vào chat riêng, không gửi vào nhóm/kênh.',
    ...
    telegramOwnerOrderAlertsLabel: 'Báo khi khách thanh toán thành công',
    telegramOwnerOrderAlertsHint: 'Chỉ báo đơn đã thanh toán thật. Email giữ tối đa 5 ký tự đầu; username Telegram giữ @ và tối đa 3 ký tự đầu, phần còn lại thay bằng x. Không gửi tên thật hoặc mã đơn.',
    telegramOwnerStuckAlertsLabel: 'Báo đơn chờ quá lâu',
    telegramOwnerStuckAlertsHint: 'Chỉ gửi vào chat riêng, một lần khi vượt thời gian bên cạnh. Không gửi vào nhóm/kênh.',
    telegramOwnerStuckMinutesLabel: 'Sau (phút)',
    telegramOwnerLowStockAlertsLabel: 'Báo kho thấp hoặc hết hàng',
    telegramOwnerLowStockAlertsHint: 'Chỉ gửi vào chat riêng. Tin không hiện ngưỡng; hết hàng kèm liên hệ hỗ trợ. Mỗi loại báo một lần, tự mở lại khi tồn vượt ngưỡng.',
    ...
    telegramPreviewTitle: 'Chat thử với bot',
    telegramPreviewHint:
      'Giả lập đúng cuộc trò chuyện: gõ tin như khách, bot trả lời bằng chính mã thật, bấm được mọi nút.',
    telegramSimPlaceholder: 'Nhắn thử như khách…',
    telegramSimSend: 'Gửi',
    telegramSimReset: 'Chat lại từ đầu',
    ...
    telegramGuideStep3: 'Chép token được đưa, dán vào ô trên rồi bật công tắc.',
