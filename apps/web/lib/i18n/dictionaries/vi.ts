...
export const vi = {
  ...
  admin: {
    ...
    telegramOwnerOrderAlertsHint: 'Chỉ báo đơn đã thanh toán thật. Khách hiển thị xxx; không gửi email, tên, username hoặc mã đơn.',
    ...
    telegramOwnerLowStockAlertsHint: 'Chỉ gửi vào chat riêng. Mỗi loại báo một lần, tự mở lại sau khi được nhập thêm.',
