...
export const en: Dictionary = {
  ...
  admin: {
    ...
    telegramOwnerOrderAlertsHint: 'Real paid orders only. Customers appear as xxx; no email, name, username or order code is sent.',
    ...
    telegramOwnerLowStockAlertsHint: 'Private chats only. Each option is notified once and resets after restocking.',
