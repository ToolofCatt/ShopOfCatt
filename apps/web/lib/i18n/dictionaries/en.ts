...
export const en: Dictionary = {
  ...
  admin: {
    ...
    telegramMembershipTitle: "Require channel membership",
    telegramMembershipHint: "Customers must join the channel before using the bot. The bot needs administrator access to verify members. Paid-order delivery continues.",
    telegramMembershipChatLabel: "Channel ID or @username",
    telegramMembershipChatHint: "Accepts a short ID or a Bot API ID starting with -100. The server normalizes it.",
    telegramMembershipLinkLabel: "Join link",
    telegramMembershipLinkHint: "Use https://t.me/channel_name or a private invite link. For public channels, leave empty and click Check channel.",
    telegramMembershipCheck: "Check channel",
    telegramMembershipChecking: "Checking…",
    telegramMembershipVerified: "Bot membership-check access verified:",
    telegramOwnerAlertsTitle: 'Store owner notifications',
    telegramOwnerAlertsPreview: 'Preview owner alert',
    telegramOutOfStockPreview: 'Out-of-stock preview',
    telegramOwnerAlertsHint:
      'The configured chat receives anonymous successful-purchase alerts. Operational alerts go only to private chats, never groups or channels.',
    ...
    telegramOwnerOrderAlertsLabel: 'Notify after successful payment',
    telegramOwnerOrderAlertsHint: 'Real paid orders only. Shows up to 5 email characters, or @ plus up to 3 Telegram username characters; the remainder becomes x. No real name or order code.',
    telegramOwnerStuckAlertsLabel: 'Notify for stalled orders',
    telegramOwnerStuckAlertsHint: 'Private chats only, once after this waiting period. Never sent to groups or channels.',
    telegramOwnerStuckMinutesLabel: 'After (minutes)',
    telegramOwnerLowStockAlertsLabel: 'Notify for low or empty stock',
    telegramOwnerLowStockAlertsHint: 'Private chats only. Thresholds stay hidden; out-of-stock alerts include support contacts. Each option is notified once and resets when stock exceeds the threshold.',
