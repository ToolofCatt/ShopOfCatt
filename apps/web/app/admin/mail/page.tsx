...
export default function AdminMailPage() {
  ...
  return <>
    ...
    {tab === 'catalog' && token && <MailPriceTable offers={offers} token={token} canSync={owner} syncing={busy} reload={() => load()} sync={() => void action(async () => { await apiFetch('/admin/mail/sync', { token, method: 'POST' }); })} />}
